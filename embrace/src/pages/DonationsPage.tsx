...
const DonationsPage: React.FC = () => {
    ...
    return (
        <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-400 mt-2 text-center">Your donation fuels creativity. Choose to support an individual artist or the entire Embrace mission.</p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 bg-gray-800 p-8 rounded-lg shadow-lg space-y-6">
                <div>
                    ...
                    >
                        <option value="label">Embrace (The Label)</option>
                        {musicians.map(m => (
