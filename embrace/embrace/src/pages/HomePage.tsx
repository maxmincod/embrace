...
const MOCK_MERCH = [
    {
        id: 'merch-1',
        itemName: 'Camiseta Logo Nova Wave',
    ...
    {
        id: 'merch-2',
        itemName: 'Vinil "Forest Path" Leo King',
        artistName: 'Leo King',
        price: 35.00,
        ...
        <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-orange-500/20 hover:scale-[1.02]">
            ...
            <div className="p-4">
                ...
                <div className="flex justify-between items-center mt-3">
                    <span className="font-semibold text-lg text-orange-400">R${item.price.toFixed(2)}</span>
        ...
        <div className="space-y-20 pb-16">
            <section className="text-center py-16 rounded-lg bg-gray-800/50">
                <h1 className="text-4xl md:text-6xl font-black tracking-tight text-white">
                    O Futuro da Música é <span className="ascend-gradient-text">Aqui</span>.
                </h1>
            ...
            <section>
                <h2 className="text-3xl font-bold mb-6 text-white">Em Alta <span className="text-base font-normal text-gray-400">(Menos Reproduções)</span></h2>
            ...
            <section>
                <h2 className="text-3xl font-bold mb-6 text-white">Recém Enviadas</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {newSongs.length > 0 ? newSongs.map(song => <SongCard key={song.id} song={song} isNew />) : <p className="text-gray-400">Nenhuma música nova nos últimos 3 dias.</p>}
                </div>
            </section>
            ...
            <section className="grid md:grid-cols-2 gap-8 items-center bg-gray-800/50 p-8 rounded-lg">
                ...
                <div className="order-1 md:order-2">
                    <img src="https://picsum.photos/seed/studio/600/400" alt="Estúdio de música" className="rounded-lg shadow-lg w-full h-full object-cover" />
                </div>
            </section>
            ...
            <section className="bg-orange-600/10 border border-orange-500/30 rounded-lg p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                <div>
                    <h3 className="text-2xl font-bold text-white">Nos ajude a continuar apoiando estrelas!</h3>
