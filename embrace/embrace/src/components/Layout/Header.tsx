                    ...
                    <div className="flex items-center">
                        ...
                        <div className="hidden md:block">
                            <div className="ml-10 flex items-baseline space-x-4">
                                <NavLink onClick={() => setPage('discover')} isActive={page === 'discover'}>Descobrir</NavLink>
                                <NavLink onClick={() => setPage('donations')} isActive={page === 'donations'}>Apoiar</NavLink>
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center">
                        {currentUser ? (
                            <>
                                {userType === 'musician' && <NavLink onClick={() => setPage('dashboard')} isActive={page === 'dashboard'}>Painel</NavLink>}
                                {userType === 'listener' && <NavLink onClick={() => setPage('profile')} isActive={page === 'profile'}>Perfil</NavLink>}
                                <button
                                    onClick={logout}
