...
const DonationsPage: React.FC = () => {
    ...
    if (isSubmitted) {
        return (
            <div className="max-w-2xl mx-auto text-center py-16">
                ...
                <h1 className="text-4xl font-bold mt-4 text-white">Thank You!</h1>
                <p className="text-gray-300 mt-2">Your support means the world to us and our artists. Together, we're building the future of music.</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-2xl mx-auto">
            <h1 className="text-4xl font-bold text-center text-white">Support the Music</h1>
            <p className="text-gray-400 mt-2 text-center">Your donation fuels creativity. Choose to support an individual artist or the entire Ascend Records mission.</p>

            <form onSubmit={handleSubmit} className="mt-8 bg-gray-800 p-8 rounded-lg shadow-lg space-y-6">
                <div>
                    <label htmlFor="recipient" className="block text-sm font-medium text-gray-300">Support</label>
                    <select
                        id="recipient"
                        value={recipient}
                    ...
                    >
                        <option value="label">Ascend Records (The Label)</option>
                        {musicians.map(m => (
                ...
                <div>
                    <label htmlFor="amount" className="block text-sm font-medium text-gray-300">Amount (USD)</label>
                    <div className="mt-1 relative rounded-md shadow-sm">
                        ...
                        <input
                            ...
                            className="block w-full pl-7 pr-12 bg-gray-700 border-gray-600 rounded-md py-2 focus:outline-none focus:ring-orange-500 focus:border-orange-500 sm:text-sm text-white"
                            placeholder="0.00"
                        />
                    </div>
                </div>
