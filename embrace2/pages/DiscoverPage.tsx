    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-gray-400 mt-2">Find your next favorite artist. Songs with the fewest plays appear first.</p>
            </div>
            ...
            {filteredSongs.length > 0 ? (
                ...
                <div className="text-center py-16 bg-gray-800 rounded-lg">
                    ...
                    <p className="text-gray-400 mt-2">Try a different genre or check back later!</p>
                </div>
            )}
        </div>
    );
